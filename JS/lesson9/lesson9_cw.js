...
for (let simpson of simpsons) {
    ...
    simpsDiv.appendChild(nameDiv);
    simpsDiv.appendChild(surnameDiv);
    simpsDiv.appendChild(ageDiv);
    simpsDiv.appendChild(infoDiv);
    simpsDiv.appendChild(photoDiv);
    document.body.appendChild(simpsDiv)
}
...
for (let coursesArrayElement of coursesArray) {
    ...
    monthhourDiv.classList.add('flex');
    let monthDiv = document.createElement('div');
    monthhourDiv.appendChild(monthDiv);
    monthDiv.innerText = `monthDuraction: ${coursesArrayElement.monthDuration}`;
    let hourDiv = document.createElement('div');
    monthhourDiv.appendChild(hourDiv);
    hourDiv.innerText = `hourDuraction: ${coursesArrayElement.hourDuration}`;
    ...
    for (let module of coursesArrayElement.modules) {
        ...
        modulesUl.appendChild(liModule);
    }

    coursesDiv.appendChild(titleDiv);
    coursesDiv.appendChild(monthhourDiv);
    coursesDiv.appendChild(modulesUl);
