...
for (let usersListElement of usersList) {
    ...
    emailDiv.innerText = usersListElement.email;
    ...
    userDiv.appendChild(addressDiv);
      ...
      streetDiv.innerText = usersListElement.address.street;
      addressDiv.appendChild(streetDiv)
      let suiteDiv = document.createElement('div');
      suiteDiv.innerText = usersListElement.address.suite;
      addressDiv.appendChild(suiteDiv);
      let cityDiv = document.createElement('div');
      cityDiv.innerText = usersListElement.address.city;
      addressDiv.appendChild(cityDiv);
      let zipcodeDiv = document.createElement('div');
      zipcodeDiv.innerText = usersListElement.address.zipcode;
      addressDiv.appendChild(zipcodeDiv);
      let geoDiv = document.createElement('div');
      geoDiv.style.paddingLeft = '20px';
      addressDiv.appendChild(geoDiv);
        let latDiv = document.createElement('div');
        latDiv.innerText = usersListElement.address.geo.lat;
        geoDiv.appendChild(latDiv);
        let lngDiv = document.createElement('div');
        lngDiv.innerText = usersListElement.address.geo.lng;
        geoDiv.appendChild(lngDiv);
    ...
    userDiv.appendChild(websiteDiv);

    let companyDiv = document.createElement('div');
    companyDiv.style.paddingLeft = '20px';
    userDiv.appendChild(companyDiv);
      let compnameDiv = document.createElement('div');
      compnameDiv.innerText = usersListElement.company.name;
      companyDiv.appendChild(compnameDiv);
      let catchPhraseDiv = document.createElement('div');
      catchPhraseDiv.innerText = usersListElement.company.catchPhrase;
      companyDiv.appendChild(catchPhraseDiv);
      let bsDiv = document.createElement('div');
      bsDiv.innerText = usersListElement.company.bs;
